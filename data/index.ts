...
export const SERVICES = [
  {
    ...
    icon: '❤️',
    title: 'Cardiology',
    description: 'Advanced cardiac care with state-of-the-art cath labs, echo diagnostics, and 24/7 cardiac ICU support.',
  },
  {
    id: 2,
    icon: '🧠',
    title: 'Neurology',
    description: 'Comprehensive brain and nervous system care including stroke management, epilepsy, and neuro-rehabilitation.',
  },
  {
    id: 3,
    icon: '🦴',
    title: 'Orthopaedics',
    description: 'Expert joint replacements, sports injuries, spine surgery, and trauma care with robotic assistance.',
  },
  {
    id: 4,
    icon: '👶',
    title: 'Paediatrics',
    description: 'Child-friendly care from newborns to adolescents with dedicated NICU and paediatric ICU units.',
  },
  {
    id: 5,
    icon: '🔬',
    title: 'Oncology',
    description: 'Comprehensive cancer care with chemotherapy, radiation therapy, immunotherapy, and palliative services.',
  },
  {
    id: 6,
    icon: '🏥',
    title: 'Emergency Care',
    description: '24/7 emergency services with rapid response teams, trauma bays, and critical care transport.',
  },
  {
    id: 7,
    icon: '👁️',
    title: 'Ophthalmology',
    description: 'Advanced eye care including LASIK, cataract surgery, glaucoma management, and retinal treatments.',
  },
  {
    id: 8,
    icon: '🫁',
    title: 'Pulmonology',
    description: 'Respiratory medicine, sleep studies, bronchoscopy, and pulmonary rehabilitation programs.',
  },
]
